...
public:
    ...
    matrix& operator*= (const matrix<T, H2, W2>& other)
    {
    ...
    template <size_t H2, size_t W2>
    matrix<T, H, W> operator* (const matrix<T, H2, W2>& second)
    {
        matrix <T, H, W> first(*this);
        return first *= second;
    }
...
int main(){
    ...
    //     }
    // }
    // matrix<int,2,3> mt3 = mt + mt1;
    // mt3.print();
    // matrix<int,3,2> mt2 = mt.transposed();
    // mt2.print();
    // std::cout<<mt2(2,0);
